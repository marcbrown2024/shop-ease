...
export const CustomeDrawerContent: React.FC<DrawerContentComponentProps> = (
  props
) => {
  ...
  return (
    ...
    >
      <View className="absolute h-32 w-full">
        <Image
          source={{
            uri: "https://firebasestorage.googleapis.com/v0/b/shop-ease-18b7c.appspot.com/o/freshProduce.jpg?alt=media&token=38530e06-64fb-4acc-af88-c95158b67655",
          }}
          resizeMode="stretch"
